<template>
  <el-card>
    <h1 class="me-author-name">一个西瓜</h1>
    <div class="me-author-description">
      <span><i class="el-icon-location-outline"></i> &nbsp;北京&海淀</span>
      <span><i class="me-icon-job"></i> &nbsp;java小白</span>
    </div>
...
<script>
  export default {
    ...
    data() {
      return {
        qq: {title: 'QQ', message: '304498473'},
        github: {
          title: 'github',
          message: '<a target="_blank" href="https://github.com/watermeloBupt">https://github.com/watermeloBupt</a>'
        },
      }
    },
    methods: {
